...
function fetchData() {
    fetch('https://cs.csub.edu/~flin/3350/lab05/index.php?controller=taskManagement&action=showAll')
...
function displayData(responseData) {
    ...
    responseData.forEach(task => {
        htmlContent += `<li>Task ID: ${task.task_id}, Task Name: ${task.task_name}, Username: ${task.username}</li>`;
    });
